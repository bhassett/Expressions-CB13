    ...
    buildDisplay: function () {
        ...
        if (this.kitProduct.getHasVat() &&
            ...
            var delUpdatePrice = function (price) {
                lblPriceValue.innerHTML = currencySymbol + ' ' + price.localeFormat(numberDecimal) + ' ' + ise.StringResource.getString('showproduct.aspx.38');
            ...
            var lblPriceValue = document.createElement('SPAN');
            lblPriceValue.innerHTML = ise.StringResource.getString('showproduct.aspx.28') + ' ' + currencySymbol + ' ' + kitPrice.localeFormat(numberDecimal);
            this.lblPrice.appendChild(lblPriceValue);
