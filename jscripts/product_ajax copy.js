...
ise.Products.Product.prototype = {
    ...
    setUnitMeasureIntrinsics: function (unitMeasures) {
        ...
        //        param.data = unitMeasures;

        //        var thisObject = this;

        //        $.ajax({
        //            type: "POST",
        //            url: "ActionService.asmx/DecriptIntrinsinctData",
        ...
        //                isFinished = true;
        //                thisObject.unitMeasures = $.parseJSON(result.d);

        //                if (thisObject.unitMeasures.length > 0) {
        //                    thisObject.;
        //                }

        //                thisObject.onAttributeChanged();
