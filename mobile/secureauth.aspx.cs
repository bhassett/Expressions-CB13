    ...
    public partial class secureauth : System.Web.UI.Page
    {
        private void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (ThisCustomer.ThisCustomerSession["3Dsecure.ACSURL"].Length == 0)
            {
                Response.Write("<HTML>\n");
                Response.Write("<BODY>\n");
                Response.Write("<center>" + AppLogic.GetString("secureauth.aspx.1", 1, ThisCustomer.LocaleSetting) + "</center>\n");
                Response.Write("</BODY>\n");
                Response.Write("</HTML>\n");
            }
            else
            {
                ...
                Response.Write("	<h1>" + AppLogic.GetString("secureauth.aspx.2", 1, ThisCustomer.LocaleSetting) + "</h1>\n");
                Response.Write("	<h2>" + AppLogic.GetString("secureauth.aspx.3", 1, ThisCustomer.LocaleSetting) + "<br></h2>\n");
                Response.Write("	<h3>" + AppLogic.GetString("secureauth.aspx.4", 1, ThisCustomer.LocaleSetting) + "</h3>\n");
                Response.Write("	</font>\n");
                Response.Write("	<input type=\"submit\" value=\"" + AppLogic.GetString("secureauth.aspx.5", 1, ThisCustomer.LocaleSetting) + "\">\n");
                Response.Write("	</center>\n");
                Response.Write("</noscript>\n");
