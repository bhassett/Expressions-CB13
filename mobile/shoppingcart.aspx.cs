...
namespace InterpriseSuiteEcommerce.mobile
{
    public partial class ShoppingCartPage : SkinBase
    {
        ...
        private void InitializeComponent()
        {
            ...
            string continueCaption = AppLogic.GetString("shoppingcart.cs.12", SkinID, ThisCustomer.LocaleSetting);
            btnContinueShoppingTop.Text = continueCaption;

            string checkoutButtonCaption = AppLogic.GetString("shoppingcart.cs.34", SkinID, ThisCustomer.LocaleSetting);
