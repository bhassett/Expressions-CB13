    ...
    <div class="wrapperbot">
        <div class="wrapperin">
            <div class="bottomer">
                <div class="footermid">
                    <p>
                        <a class="foot" href="t-copyright.aspx">Copyright &copy; 2013. All Rights Reserved.</a>
                    </p>
                    <div>
                        <ul id="footer-menu">
                    ...
                    <div id="powered-by">
                        <span>Powered by </span><a href="http://connectedbusiness.com/"
                            target="_blank" title="e-Commerce Shopping Cart">Connected Business eCommerce Shopping
                            Cart</a>
                        <br />
                        <noscript>
