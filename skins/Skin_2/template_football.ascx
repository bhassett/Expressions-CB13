...
<body>
    ...
    <div class="wrappertop" style="background-image: url(skins/Skin_(!SKINID!)/images/cs_football_bg.jpg);">

        <!-- Page Header -->
        <div class="wrappertopbar">
            <div class="wrappertopbar2" style="background-image: url(skins/Skin_(!SKINID!)/images/temptitler_football.png);">
                <div class="wrapperin">
                <!-- Logo -->
        ...
        <div class="wrappernavbar" style="background-image: url(skins/Skin_(!SKINID!)/images/cs_topbg2_green.jpg);">
            <div class="wrapperin">
                <!-- Menu -->
    ...
    <div class="wrapperbot">
        <div class="wrapperin">
            <div class="bottomer">
                <div class="footermid">
                    <p><a class="foot" href="t-copyright.aspx">Copyright &copy; 2013. All Rights Reserved.</a></p>
                    <center>
                        <ul id="footer-menu">
